...
export default function AuthFlow({ onComplete, children }: AuthFlowProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-50 bg-gradient-to-br from-gray-900 via-purple-900 to-black flex flex-col overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto overscroll-none">
        <div className="flex flex-col items-center justify-center min-h-full px-6 py-8">
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 overflow-hidden max-w-sm w-full">
            <div className="flex flex-col items-center p-6">
              ...
              <h2 className="text-xl font-bold text-white mb-2">Verify with World ID</h2>
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-3.5 px-6 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-2xl shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
              >
                {loading ? (
                  <>
          ...
          <div className="mt-6 text-center">
            <h1 className="text-lg font-bold text-white">AdWatch</h1>
